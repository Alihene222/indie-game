...
public class TileMesh {
    ...
    public void prepareRender() {
        ...
        glVertexAttribPointer(0, 3, GL_FLOAT, false, TILE_MESH_VERTEX_SIZE_BYTES, 0);
        glEnableVertexAttribArray(0);
        glVertexAttribPointer(1, 2, GL_FLOAT, false, TILE_MESH_VERTEX_SIZE_BYTES, 3 * Float.BYTES);
        glEnableVertexAttribArray(1);
        glVertexAttribPointer(2, 1, GL_FLOAT, false, TILE_MESH_VERTEX_SIZE_BYTES, 5 * Float.BYTES);
